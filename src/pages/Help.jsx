...
const faqCategories = [
  ...
  {
    title: "Staff Logins & Roles",
    icon: KeyRound,
    faqs: [
      {
        question: "How do I get a login?",
        answer: "Your manager, owner, or super admin either gives you a username or phone number plus a password directly (My Business > Team > Staff Logins), or you can sign in with Google - in that case a super admin assigns your branch and role afterward before your dashboard shows anything."
      },
      {
        question: "I signed in with Google but my Dashboard is empty - is something wrong?",
        answer: "No - that's expected the first time. Your account exists, but a super admin still needs to assign your branch and role. Once they do, use the \"Check again\" button on that screen, or sign out and sign back in, and your dashboard will show your work."
      },
      {
        question: "I forgot my password - how do I reset it?",
        answer: "If you sign in with a username or phone number (no \"@\"), passwords are reset by your manager, owner, or a super admin from My Business > Team > Staff Logins - ask them directly. If you sign in with a real email address, use \"Forgot password?\" on the sign-in page instead."
      },
      {
        question: "What can each role do?",
        answer: "Owner: full access to everything, including billing and branch setup. Manager: staff, services, and reports for their branch. Cashier: payments and check-ins. Staff: wash operations only - check-in, start, and complete washes."
      }
    ]
  },
  {
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div>
        ...
        <p className="text-slate-500 dark:text-slate-400">
          Answers for staff - logins, workflows, and day-to-day questions.
        </p>
      </div>
