...
export default function DashboardSuperAdminGate() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[50vh] gap-4 text-center">
      <div className="h-16 w-16 rounded-full bg-brand-navy-100 flex items-center justify-center">
        <Activity className="h-8 w-8 text-brand-navy" />
      </div>
      ...
      <Link to={createPageUrl("SuperAdminDashboard")}>
        <Button className="bg-gradient-to-r from-brand-navy to-brand-blue-mid">
