...
// Official Facebook brand mark (via https://svgl.app/directory/social) - kept
// as its true multi-color logo rather than a generic outline icon so the
// footer social link is instantly recognizable as Facebook.
export default function FacebookIcon({ className }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 666.667 666.667" className={className}>
      <defs>
        <clipPath id="facebook-icon-clip" clipPathUnits="userSpaceOnUse">
          <path d="M0 700h700V0H0Z" />
        </clipPath>
      </defs>
      <g clipPath="url(#facebook-icon-clip)" transform="matrix(1.33333 0 0 -1.33333 -133.333 800)">
        <path
